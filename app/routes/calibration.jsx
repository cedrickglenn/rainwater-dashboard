...
export const meta = () => [
  ...
  { name: 'description', content: 'Wireless sensor calibration via ESP32 bridge' },
];
  ...
  return (
    ...
    >
      ...
      <span className="font-mono text-xs">
        {data.ok ? `Queued → ${data.queued}` : data.error ?? 'Failed to send command'}
      </span>
    </div>
  );
}
    ...
    >
      ...
      <div className="space-y-3">
        ...
        <div className="space-y-2 pl-1">
          ...
          <Step number="4" text="Press Capture — the Mega reads the current ADC voltage as the neutral point and saves to EEPROM." />
        </div>
      ...
      <div className="space-y-3">
        ...
        <div className="space-y-2 pl-1">
          ...
          <Step number="3" text="Wait ~60 s for the voltage to stabilize." />
          <Step number="4" text="Press Capture — the Mega reads the ADC voltage as the acid point and saves to EEPROM." />
        </div>
        <fetcher.Form method="post">
          <input type="hidden" name="command"   value="CAL_PH" />
          <input type="hidden" name="container" value={container} />
  ...
  return (
    ...
    >
      ...
      <div className="space-y-3">
        ...
        <div className="space-y-2 pl-1">
          <Step number="1" text="Prepare a turbidity standard (e.g., diluted formazin or a powdered-milk solution with a known NTU value)." />
      ...
      <div className="grid gap-4 sm:grid-cols-2">
        ...
        <div className="space-y-3 rounded-lg border p-4">
          ...
          <p className="text-xs text-muted-foreground">
            Make sure the container is completely empty. The sensor captures
            its current distance as the 0% reference.
          </p>
          <fetcher.Form method="post">
...
function TemperatureTab() {
  ...
  return (
    ...
    >
      ...
      <div className="space-y-3">
        <p className="text-xs text-muted-foreground">
          Measure actual water temperature with a calibrated reference thermometer.
          Calculate: <strong>offset = reference − sensor reading</strong>.
          Example: sensor reads 27.5 °C, reference reads 27.0 °C → offset = −0.5.
        </p>
        <div className="flex items-center gap-3">
    ...
    >
      <div className="space-y-3">
        <p className="text-xs text-muted-foreground">
          ...
          The default of 450 PPL suits YF-S201 sensors at typical low flow rates.
        </p>
        <div className="flex items-center gap-3">
  ...
  return (
    <Card className="border-red-200 dark:border-red-900">
      <CardHeader>
        ...
        <CardDescription>
          Resets every calibration value on the Arduino Mega to firmware defaults
          and overwrites EEPROM. This cannot be undone remotely.
        </CardDescription>
      </CardHeader>
      ...
      <Card className="border-blue-200 bg-blue-50 dark:border-blue-900 dark:bg-blue-950/20">
        <CardContent className="flex items-start gap-3 p-4">
          ...
          <p className="text-sm text-blue-700 dark:text-blue-300">
            <strong>How it works:</strong> Each button queues a command to the backend.
            The ESP32 picks it up within ~3 s and forwards it to the Mega over UART.
            The Mega takes the reading, saves to EEPROM, and sends an ACK back.
            Allow 5–10 seconds total before checking results.
          </p>
        </CardContent>
      </Card>
